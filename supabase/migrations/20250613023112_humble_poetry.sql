/*
  # Fix duplicate key error with enhanced RPC function

  1. Changes
    - Update the register_telegram_user RPC function to handle supabase_auth_id
    - Add proper upsert logic to prevent duplicate key errors
    - Include all necessary user fields in the function

  2. Security
    - Uses SECURITY DEFINER to bypass RLS safely
    - Validates input parameters
    - Handles both new registrations and updates atomically
*/
