/*
  # Task Consumption System

  1. New Tables
    - `task_clicks` - Records individual clicks on paid tasks
      - `id` (uuid, primary key)
      - `task_id` (uuid, references paid_tasks)
      - `user_telegram_id` (text, references users)
  ...
  3. Security
    - RLS policies for task_clicks and task_click_batches
    - Trigger to update task status when clicks reach target
*/
