/*
  # Add paid tasks integration functions

  1. New Functions
    - `get_active_paid_tasks` - Gets all active paid tasks for display
    ...
    - `get_user_completed_paid_tasks` - Gets completed paid tasks for a user
    - `get_active_paid_tasks_for_daily` - Gets active paid tasks for the daily tasks section

  2. Changes
    - Drops and recreates `get_user_paid_tasks` function to include lyra_per_click
*/
