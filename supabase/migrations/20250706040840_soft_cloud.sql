/*
  # Paid Tasks Integration

  1. New Functions
    - `get_active_paid_tasks` - Returns all active paid tasks for display in daily tasks section
    - `record_task_click_with_rewards` - Records a click on a paid task and awards points and minutes to the user
  
  2. Security
    - Add RLS policies to ensure users can only interact with appropriate tasks
    - Ensure proper validation of task status and user permissions
*/
