/*
  ...
  1. تحديث الوظائف
    - `process_referral` - لقبول المستخدمين بدون أسماء مستخدم
    - `register_telegram_user` - لمعالجة أفضل للمستخدمين غير المسمين
    - `get_referral_stats_secure` - لعرض أفضل للمستخدمين غير المسمين

  2. الأمان
    - الحفاظ على جميع التحققات الأمنية الموجودة
    - منع الإحالة الذاتية
    - التحقق من عدم وجود إحالات مكررة

  3. التحسينات
    - عرض "مستخدم جديد" للمستخدمين بدون أسماء
    - دعم كامل لنظام المكافآت
    - إحصائيات دقيقة للإحالات
*/
